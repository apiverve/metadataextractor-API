# Metadata Extractor Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:metadataextractor-api:1.1.12'
}
```
...
```java
import com.apiverve.metadataextractor.MetadataExtractorAPIClient;
import com.apiverve.metadataextractor.APIResponse;
import com.apiverve.metadataextractor.APIException;

// Initialize the client
MetadataExtractorAPIClient client = new MetadataExtractorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/metadataextractor](https://docs.apiverve.com/ref/metadataextractor)
...
- **Documentation:** [https://docs.apiverve.com/ref/metadataextractor](https://docs.apiverve.com/ref/metadataextractor)
- **Issues:** [GitHub Issues](https://github.com/apiverve/metadataextractor-api/issues)
